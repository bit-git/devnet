...
RUN apk update && apk upgrade && apk add bash gcc musl-dev libc-dev libc6-compat linux-headers build-base git libffi-dev openssl-dev curl libxml2-dev libxslt-dev
